...
You can also work with ADMGs (Acyclic Directed Mixed Graphs) which combine directed edges with bidirected edges representing latent confounding:
...
| **ADMG, PAG & mixed‑graph support**   | Native edge codes for ADMGs, PAGs (`o->`, `o-o`, `--o`) and bidirected/undirected edges.                                                                      | Analyse outputs of discovery algorithms like FCI or RFCI, and work with graphs containing latent confounding out‑of‑the‑box.  |
