...
You can create simple graphs as well as a number of predefined graph classes. Currently, we support `"UNKNOWN"`, `"DAG"`, `"PDAG"`, and `"PAG"`. We plan on supporting several other causal graph types in future releases, such as `"MAG"`, `"SWIG"`, and `"ADMG"`.
