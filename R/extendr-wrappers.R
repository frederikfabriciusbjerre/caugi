...
edge_registry_register_builtins <- function(reg) .Call(wrap__edge_registry_register_builtins, reg)

edge_registry_seal <- function(reg) .Call(wrap__edge_registry_seal, reg)
...
rs_set_edges <- function(session, from, to, etype) .Call(wrap__rs_set_edges, session, from, to, etype)

rs_replace_edges <- function(session, from, to, etype) .Call(wrap__rs_replace_edges, session, from, to, etype)

rs_set_n <- function(session, n) .Call(wrap__rs_set_n, session, n)

rs_set_simple <- function(session, simple) .Call(wrap__rs_set_simple, session, simple)

rs_set_class <- function(session, class) .Call(wrap__rs_set_class, session, class)

rs_resolve_class <- function(session, class) .Call(wrap__rs_resolve_class, session, class)

rs_set_names <- function(session, names) .Call(wrap__rs_set_names, session, names)
...
rs_build <- function(session) .Call(wrap__rs_build, session)
...
graph_builder_add_edges <- function(b, from, to, etype) .Call(wrap__graph_builder_add_edges, b, from, to, etype)
...
rs_write_caugi_file <- function(session, reg, graph_class, path, comment, tags) .Call(wrap__rs_write_caugi_file, session, reg, graph_class, path, comment, tags)
