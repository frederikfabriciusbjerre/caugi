...
impl GraphView {
    ...
    pub fn parents_of(&self, i: u32) -> Result<&[u32], String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.parents_of(i)),
    ...
    pub fn children_of(&self, i: u32) -> Result<&[u32], String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.children_of(i)),
    ...
    pub fn undirected_of(&self, i: u32) -> Result<&[u32], String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.undirected_of(i)),
    ...
    pub fn neighbors_of(&self, i: u32) -> Result<&[u32], String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.neighbors_of(i)),
    ...
    pub fn ancestors_of(&self, i: u32) -> Result<Vec<u32>, String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.ancestors_of(i)),
    ...
    pub fn descendants_of(&self, i: u32) -> Result<Vec<u32>, String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.descendants_of(i)),
    ...
    pub fn markov_blanket_of(&self, i: u32) -> Result<Vec<u32>, String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.markov_blanket_of(i)),
    ...
    pub fn exogenous_nodes(&self, undirected_as_parents: bool) -> Result<Vec<u32>, String> {
        match self {
            ...
            GraphView::Pag(g) => Ok(g.exogenous_nodes(undirected_as_parents)),
    ...
    pub fn induced_subgraph(&self, keep: &[u32]) -> Result<GraphView, String> {
        ...
        let gv = match self {
            ...
            GraphView::Pag(_) => {
                let p = super::pag::Pag::new(std::sync::Arc::new(core2))?;
                GraphView::Pag(std::sync::Arc::new(p))
            }
...
impl GraphView {
    pub fn to_cpdag(&self) -> Result<GraphView, String> {
        match self {
            ...
            GraphView::Pag(_) => Err("to_cpdag is not defined for PAGs".into()),
