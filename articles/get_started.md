...
cg
#> <caugi object; 4 nodes, 4 edges; simple: TRUE; built: TRUE; ptr=0x55a9880868d0>
#>   graph_class: DAG
#>   nodes: A, B, C, D
...
``` r
caugi(A %-->% B, B %-->% A)
#> Error in graph_builder_add_edges(b, as.integer(unname(id[edges$from])), : Parallel edges not allowed in simple graphs (0 -> 1)
```
