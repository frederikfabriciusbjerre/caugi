...
cg
#> <caugi object; 4 nodes, 4 edges; simple: TRUE; session=0x55e3ffe93140>
#>   graph_class: DAG
#>   nodes: A, B, C, D
...
cg_modified <- cg |>
  ...
  add_edges(B %-->% A, D %-->% C)
cg_modified
#> <caugi object; 4 nodes, 3 edges; simple: TRUE; session=0x55e40615f330>
#>   graph_class: DAG
#>   nodes: A, B, C, D
#>   edges: A-->C, B-->A, D-->C
```
...
[`remove_nodes()`](https://caugi.org/reference/caugi_verbs.md), etc.).
