...
You can create simple graphs as well as a large number of predefined graph classes. Currently, we support `"Unknown"`, `"DAG"`, `"PDAG"`, and `"ADMG"`. We plan on supporting several other causal graph types in future releases, such as `"PAG"`, `"CPDAG"`, `"MAG"`, and `"SWIG"`.
...
For graphs with latent confounding, you can use the ADMG (Acyclic Directed Mixed Graph) class:

```{r}
# an ADMG with directed and bidirected edges
admg <- caugi_graph(
  X %-->% Y,
  X %<->% Y,  # bidirected edge representing latent confounding
  Z %-->% X,
  Z %-->% Y,
  class = "ADMG"
)
...
* Graph classes: PAG, CPDAG, MAG, SWIG,
* Additional algorithms for ADMGs,
* ...and much more! 
